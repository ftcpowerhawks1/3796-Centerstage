...
public class Odotesting extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        frontRight = new MotorEx(hardwareMap, "Right Front Motor");
        frontLeft = new MotorEx(hardwareMap, "Left Front Motor");
        backRight = new MotorEx(hardwareMap, "Right Back Motor");
        backLeft = new MotorEx(hardwareMap, "Left Back Motor");
